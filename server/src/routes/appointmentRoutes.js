...
router.post('/', protect, authorize('CUSTOMER'), auditAction('APPOINTMENT_CREATE_CUSTOMER'), createAppointment);
router.post('/provider', protect, authorize('SALON_OWNER', 'STAFF'), auditAction('APPOINTMENT_CREATE_PROVIDER'), createProviderAppointment);
...
router.patch('/:id/cancel-vnpay', protect, authorize('CUSTOMER'), auditAction('APPOINTMENT_CANCEL_VNPAY_ROLLBACK'), cancelPendingVnpayAppointment);
router.patch('/:id/cancel', protect, authorize('CUSTOMER'), auditAction('APPOINTMENT_CANCEL_CUSTOMER'), cancelCustomerAppointment);
